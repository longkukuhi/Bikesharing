(function(global) {
	...
	Samples.items = [{
		...
		items: [{
			...
			path: 'charts/combo-bar-showTotalCounts24H.html'
		}]
	}, {
		title: 'Linear scale',
		items: [{
		...
		items: [{
			title: 'Line',
			path: 'scales/logarithmic/showTotalCounts24H.html'
		}, {
			title: 'Scatter',
		...
		items: [{
			title: 'Line',
			path: 'scales/time/showTotalCounts24H.html'
		}, {
		...
		items: [{
			...
			path: 'tooltips/custom-showTotalCounts24H.html'
		}, {
		...
		items: [{
			...
			title: 'Line Chart',
			path: 'scriptable/showTotalCounts24H.html'
		}, {
